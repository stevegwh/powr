...
namespace Valve.VR
{
    ...
    public class SteamVR_Input_ActionSet_default : Valve.VR.SteamVR_ActionSet
    {
        ...
        public virtual SteamVR_Action_Boolean CalibrateButton
        {
            get
            {
                return SteamVR_Actions.default_CalibrateButton;
            }
        }
        
        public virtual SteamVR_Action_Boolean MoveMarkerDown
        {
            get
            {
                return SteamVR_Actions.default_MoveMarkerDown;
            }
        }
