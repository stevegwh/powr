...
namespace Valve.VR.InteractionSystem
{
	...
	public class CCSSTeleport : MonoBehaviour
    {
		...
		//-------------------------------------------------
		private static CCSSTeleport _instance;
		public static CCSSTeleport instance
		{
			get
			{
				if ( _instance == null )
				{
					_instance = GameObject.FindObjectOfType<CCSSTeleport>();
				}
		...
		private void TeleportPlayer()
		{
			...
			TransitionShooterRoom.StartTransition();
